...
#entrega 1
def leerImprimir():
    tamañoMapa= input("tamaño del mapa: ").split ()
    posicion= input("posicion: ").split ()
    instrucciones= input("instrucciones: ")
    cont= 0
    a= []
    for i in range (len(instrucciones)):
        a.append (instrucciones[i]) 
    while posicion != []:
        if cont < 1:
            print (tamañoMapa)
            cont += 1
...
#pregunta 4
def obtenerPuntosEquipo (matriz,equipo):
    cont= 0
    puntos= 0
    while cont < len(matriz):
        if matriz[cont][0]== equipo:
            if matriz[cont][1]>matriz[cont][3]:
                puntos+=3
            if matriz[cont][1]==matriz[cont][3]:
                puntos+=1
            if matriz[cont][1]<matriz[cont][3]:
...
obtenerPuntosEquipo ([["America", 3, "Cali", 0],
["Junior", 2, "America", 3],
["Santafe", 2, "Junior", 1],
["Cali", 2, "Junior", 2],
